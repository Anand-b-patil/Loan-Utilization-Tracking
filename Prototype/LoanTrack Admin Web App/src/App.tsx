...
import { BeneficiaryHelp } from './components/beneficiary/help';
...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (currentPath.startsWith('/b/')) {
      ...
      if (currentPath.startsWith('/b/help')) {
        return <BeneficiaryHelp onNavigate={handleNavigate} />;
      }
      // /b/submissions/:id
      ...
      // Unknown beneficiary path -> show dashboard instead of generic fallback
      return <BeneficiaryDashboard onNavigate={handleNavigate} />;
    }
